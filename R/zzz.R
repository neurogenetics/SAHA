...
.onAttach <- function(...) {
   packageStartupMessage("Thank you for using SAHA. If you choose to use this in any preprints or publication, please cite using the zenodo DOI linked to this repo: 10.5281/zenodo.14040698.")
}
